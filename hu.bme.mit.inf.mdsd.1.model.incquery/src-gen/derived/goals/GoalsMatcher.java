...
/**
 * Generated pattern matcher API of the derived.goals pattern, 
 ...
 * 
 */
public class GoalsMatcher extends BaseGeneratedMatcher<GoalsMatch> {
  ...
  public GoalsMatch newMatch(final Team pTeam, final Event pEvent) {
    return new GoalsMatch.Immutable(pTeam, pEvent);
  ...
  @Override
  protected GoalsMatch tupleToMatch(final Tuple t) {
    try {
    	return new GoalsMatch.Immutable((model.Team) t.get(POSITION_TEAM), (model.Event) t.get(POSITION_EVENT));	
  ...
  @Override
  protected GoalsMatch arrayToMatch(final Object[] match) {
    try {
    	return new GoalsMatch.Immutable((model.Team) match[POSITION_TEAM], (model.Event) match[POSITION_EVENT]);
  ...
  @Override
  protected GoalsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new GoalsMatch.Mutable((model.Team) match[POSITION_TEAM], (model.Event) match[POSITION_EVENT]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
