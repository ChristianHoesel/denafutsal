...
/**
 * Pattern-specific match representation of the derived.goals pattern, 
 * to be used in conjunction with {@link GoalsMatcher}.
 * 
 ...
 * 
 */
public abstract class GoalsMatch extends BasePatternMatch {
  private Team fTeam;
  ...
  private GoalsMatch(final Team pTeam, final Event pEvent) {
    this.fTeam = pTeam;
    this.fEvent = pEvent;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof GoalsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  static final class Mutable extends GoalsMatch {
  ...
  static final class Immutable extends GoalsMatch {
