...
/**
 * Pattern-specific match representation of the derived.goalCount pattern, 
 * to be used in conjunction with {@link GoalCountMatcher}.
 * 
 ...
 * 
 */
public abstract class GoalCountMatch extends BasePatternMatch {
  private Team fTeam;
  ...
  private GoalCountMatch(final Team pTeam, final Integer pTarget) {
    this.fTeam = pTeam;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof GoalCountMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  static final class Mutable extends GoalCountMatch {
  ...
  static final class Immutable extends GoalCountMatch {
