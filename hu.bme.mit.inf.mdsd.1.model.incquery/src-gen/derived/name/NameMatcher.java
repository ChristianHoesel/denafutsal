...
import derived.name.NameMatcherFactory;
...
/**
 * Generated pattern matcher API of the derived.name pattern, 
 ...
 * 
 * @see NameMatch
 * @see NameMatcherFactory
 * @see NameProcessor
 * 
 */
public class NameMatcher extends BaseGeneratedMatcher<NameMatch> {
   ...
   * 
   */
  public Collection<NameMatch> getAllMatches(final Role pRole, final String pName) {
    return rawGetAllMatches(new Object[]{pRole, pName});
  }
   ...
   * 
   */
  public NameMatch getOneArbitraryMatch(final Role pRole, final String pName) {
   ...
   * 
   */
  public void forEachMatch(final Role pRole, final String pName, final IMatchProcessor<? super NameMatch> processor) {
    rawForEachMatch(new Object[]{pRole, pName}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Role pRole, final String pName, final IMatchProcessor<? super NameMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<NameMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Role pRole, final String pName) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pRole, pName});
  }
   ...
   * 
   */
  public NameMatch newMatch(final Role pRole, final String pName) {
    return new NameMatch.Immutable(pRole, pName);
   ...
   * 
   */
  public Set<Role> getAllValuesOfrole(final NameMatch partialMatch) {
  ...
  public Set<Role> getAllValuesOfrole(final String pName) {
    return rawAccumulateAllValuesOfrole(new Object[]{null, pName});
  }
  ...
  public Set<String> getAllValuesOfname(final Role pRole) {
    return rawAccumulateAllValuesOfname(new Object[]{pRole, null});
  }
  
  @Override
  protected NameMatch tupleToMatch(final Tuple t) {
    try {
    	return new NameMatch.Immutable((model.Role) t.get(POSITION_ROLE), (java.lang.String) t.get(POSITION_NAME));	
  ...
  protected NameMatch arrayToMatch(final Object[] match) {
    try {
    	return new NameMatch.Immutable((model.Role) match[POSITION_ROLE], (java.lang.String) match[POSITION_NAME]);
  ...
  protected NameMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new NameMatch.Mutable((model.Role) match[POSITION_ROLE], (java.lang.String) match[POSITION_NAME]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IMatcherFactory<NameMatcher> factory() throws IncQueryException {
    return NameMatcherFactory.instance();
  }
}
