...
/**
 * Pattern-specific match representation of the derived.redBans pattern, 
 * to be used in conjunction with {@link RedBansMatcher}.
 * 
 ...
 * 
 */
public abstract class RedBansMatch extends BasePatternMatch {
  private Team fTeam;
  ...
  private RedBansMatch(final Team pTeam, final Event pEvent) {
    this.fTeam = pTeam;
    this.fEvent = pEvent;
  ...
  public String[] parameterNames() {
    return RedBansMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RedBansMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    RedBansMatch other = (RedBansMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return RedBansMatcher.factory().getPattern();
  ...
  static final class Mutable extends RedBansMatch {
  ...
  static final class Immutable extends RedBansMatch {
