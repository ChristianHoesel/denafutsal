...
/**
 * Pattern-specific match representation of the constraints.teamMemberHasIllegalEvent pattern, 
 * to be used in conjunction with {@link TeamMemberHasIllegalEventMatcher}.
 * 
 ...
 * 
 */
public abstract class TeamMemberHasIllegalEventMatch extends BasePatternMatch {
  ...
  private TeamMemberHasIllegalEventMatch(final TeamMember pTeamMember, final Team pTeam) {
  ...
  public String[] parameterNames() {
    return TeamMemberHasIllegalEventMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeamMemberHasIllegalEventMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TeamMemberHasIllegalEventMatch other = (TeamMemberHasIllegalEventMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TeamMemberHasIllegalEventMatcher.factory().getPattern();
  ...
  static final class Mutable extends TeamMemberHasIllegalEventMatch {
  ...
  static final class Immutable extends TeamMemberHasIllegalEventMatch {
