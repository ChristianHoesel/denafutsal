...
/**
 * Pattern-specific match representation of the constraints.moreRedCards pattern, 
 * to be used in conjunction with {@link MoreRedCardsMatcher}.
 * 
 ...
 * 
 */
public abstract class MoreRedCardsMatch extends BasePatternMatch {
  private TeamMember fTeamMember;
  
  private static String[] parameterNames = {"TeamMember"};
  
  private MoreRedCardsMatch(final TeamMember pTeamMember) {
  ...
  public String[] parameterNames() {
    return MoreRedCardsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MoreRedCardsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    MoreRedCardsMatch other = (MoreRedCardsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return MoreRedCardsMatcher.factory().getPattern();
  ...
  static final class Mutable extends MoreRedCardsMatch {
  ...
  static final class Immutable extends MoreRedCardsMatch {
