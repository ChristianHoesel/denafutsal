...
/**
 * Generated pattern matcher API of the constraints.notUniqueShirtNo pattern, 
 ...
 * @see NotUniqueShirtNoMatcherFactory
 * @see NotUniqueShirtNoProcessor
 * 
 */
public class NotUniqueShirtNoMatcher extends BaseGeneratedMatcher<NotUniqueShirtNoMatch> {
   ...
   * 
   */
  public NotUniqueShirtNoMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   * 
   */
  public NotUniqueShirtNoMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a NotUniqueShirtNoMatch object.
   * 
   */
  public Collection<NotUniqueShirtNoMatch> getAllMatches(final TeamMember pTeamMember, final Team pTeam) {
   ...
   * @param pTeamMember the fixed value of pattern parameter TeamMember, or null if not bound.
   * @param pTeam the fixed value of pattern parameter Team, or null if not bound.
   * @return a match represented as a NotUniqueShirtNoMatch object, or null if no match is found.
   * 
   */
  public NotUniqueShirtNoMatch getOneArbitraryMatch(final TeamMember pTeamMember, final Team pTeam) {
   ...
   * 
   */
  public void forEachMatch(final TeamMember pTeamMember, final Team pTeam, final IMatchProcessor<? super NotUniqueShirtNoMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final TeamMember pTeamMember, final Team pTeam, final IMatchProcessor<? super NotUniqueShirtNoMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<NotUniqueShirtNoMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final TeamMember pTeamMember, final Team pTeam) {
   ...
   * 
   */
  public NotUniqueShirtNoMatch newMatch(final TeamMember pTeamMember, final Team pTeam) {
    return new NotUniqueShirtNoMatch.Immutable(pTeamMember, pTeam);
   ...
   * 
   */
  public Set<TeamMember> getAllValuesOfTeamMember(final NotUniqueShirtNoMatch partialMatch) {
   ...
   * 
   */
  public Set<Team> getAllValuesOfTeam(final NotUniqueShirtNoMatch partialMatch) {
  ...
  @Override
  protected NotUniqueShirtNoMatch tupleToMatch(final Tuple t) {
    try {
    	return new NotUniqueShirtNoMatch.Immutable((model.TeamMember) t.get(POSITION_TEAMMEMBER), (model.Team) t.get(POSITION_TEAM));	
  ...
  @Override
  protected NotUniqueShirtNoMatch arrayToMatch(final Object[] match) {
    try {
    	return new NotUniqueShirtNoMatch.Immutable((model.TeamMember) match[POSITION_TEAMMEMBER], (model.Team) match[POSITION_TEAM]);
  ...
  @Override
  protected NotUniqueShirtNoMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new NotUniqueShirtNoMatch.Mutable((model.TeamMember) match[POSITION_TEAMMEMBER], (model.Team) match[POSITION_TEAM]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IMatcherFactory<NotUniqueShirtNoMatcher> factory() throws IncQueryException {
    return NotUniqueShirtNoMatcherFactory.instance();
  }
}
