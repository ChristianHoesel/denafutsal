...
/**
 * Pattern-specific match representation of the constraints.moreYellowCards pattern, 
 * to be used in conjunction with {@link MoreYellowCardsMatcher}.
 * 
 ...
 * 
 */
public abstract class MoreYellowCardsMatch extends BasePatternMatch {
  private TeamMember fTeamMember;
  
  private static String[] parameterNames = {"TeamMember"};
  
  private MoreYellowCardsMatch(final TeamMember pTeamMember) {
  ...
  public String[] parameterNames() {
    return MoreYellowCardsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MoreYellowCardsMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    MoreYellowCardsMatch other = (MoreYellowCardsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return MoreYellowCardsMatcher.factory().getPattern();
  ...
  static final class Mutable extends MoreYellowCardsMatch {
  ...
  static final class Immutable extends MoreYellowCardsMatch {
