...
/**
 * Pattern-specific match representation of the constraints.subsAreTwice pattern, 
 * to be used in conjunction with {@link SubsAreTwiceMatcher}.
 * 
 ...
 * 
 */
public abstract class SubsAreTwiceMatch extends BasePatternMatch {
  private Team fTeam;
  ...
  private SubsAreTwiceMatch(final Team pTeam, final TeamMember pSub) {
    this.fTeam = pTeam;
    this.fSub = pSub;
  ...
  public String[] parameterNames() {
    return SubsAreTwiceMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SubsAreTwiceMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    SubsAreTwiceMatch other = (SubsAreTwiceMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return SubsAreTwiceMatcher.factory().getPattern();
  ...
  static final class Mutable extends SubsAreTwiceMatch {
  ...
  static final class Immutable extends SubsAreTwiceMatch {
