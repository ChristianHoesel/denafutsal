...
/**
 * Pattern-specific match representation of the constraints.staffsAreNotInTheTeam pattern, 
 * to be used in conjunction with {@link StaffsAreNotInTheTeamMatcher}.
 * 
 ...
 * 
 */
public abstract class StaffsAreNotInTheTeamMatch extends BasePatternMatch {
  private Team fTeam;
  ...
  private StaffsAreNotInTheTeamMatch(final Team pTeam, final TeamMember pStaffMember) {
    this.fTeam = pTeam;
  ...
  public String[] parameterNames() {
    return StaffsAreNotInTheTeamMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof StaffsAreNotInTheTeamMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    StaffsAreNotInTheTeamMatch other = (StaffsAreNotInTheTeamMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return StaffsAreNotInTheTeamMatcher.factory().getPattern();
  ...
  static final class Mutable extends StaffsAreNotInTheTeamMatch {
  ...
  static final class Immutable extends StaffsAreNotInTheTeamMatch {
