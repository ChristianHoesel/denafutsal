...
/**
 * Pattern-specific match representation of the constraints.tooMuchBan pattern, 
 * to be used in conjunction with {@link TooMuchBanMatcher}.
 * 
 ...
 * 
 */
public abstract class TooMuchBanMatch extends BasePatternMatch {
  private Team fTeam;
  
  private static String[] parameterNames = {"Team"};
  
  private TooMuchBanMatch(final Team pTeam) {
    this.fTeam = pTeam;
  ...
  public String[] parameterNames() {
    return TooMuchBanMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TooMuchBanMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    TooMuchBanMatch other = (TooMuchBanMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return TooMuchBanMatcher.factory().getPattern();
  ...
  static final class Mutable extends TooMuchBanMatch {
  ...
  static final class Immutable extends TooMuchBanMatch {
