...
/**
 * Pattern-specific match representation of the constraints.refereeNotPerson pattern, 
 * to be used in conjunction with {@link RefereeNotPersonMatcher}.
 * 
 ...
 * 
 */
public abstract class RefereeNotPersonMatch extends BasePatternMatch {
  private TeamMember fPerson;
  
  private static String[] parameterNames = {"Person"};
  
  private RefereeNotPersonMatch(final TeamMember pPerson) {
  ...
  public String[] parameterNames() {
    return RefereeNotPersonMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RefereeNotPersonMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    RefereeNotPersonMatch other = (RefereeNotPersonMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return RefereeNotPersonMatcher.factory().getPattern();
  ...
  static final class Mutable extends RefereeNotPersonMatch {
  ...
  static final class Immutable extends RefereeNotPersonMatch {
