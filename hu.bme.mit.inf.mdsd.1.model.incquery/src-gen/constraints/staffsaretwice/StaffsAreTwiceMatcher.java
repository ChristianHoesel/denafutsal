...
/**
 * Generated pattern matcher API of the constraints.staffsAreTwice pattern, 
 ...
 * @see StaffsAreTwiceMatcherFactory
 * @see StaffsAreTwiceProcessor
 * 
 */
public class StaffsAreTwiceMatcher extends BaseGeneratedMatcher<StaffsAreTwiceMatch> {
   ...
   * 
   */
  public StaffsAreTwiceMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   * 
   */
  public StaffsAreTwiceMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a StaffsAreTwiceMatch object.
   * 
   */
  public Collection<StaffsAreTwiceMatch> getAllMatches(final Team pTeam, final TeamMember pStaffMember) {
   ...
   * @param pTeam the fixed value of pattern parameter Team, or null if not bound.
   * @param pStaffMember the fixed value of pattern parameter StaffMember, or null if not bound.
   * @return a match represented as a StaffsAreTwiceMatch object, or null if no match is found.
   * 
   */
  public StaffsAreTwiceMatch getOneArbitraryMatch(final Team pTeam, final TeamMember pStaffMember) {
   ...
   * 
   */
  public void forEachMatch(final Team pTeam, final TeamMember pStaffMember, final IMatchProcessor<? super StaffsAreTwiceMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Team pTeam, final TeamMember pStaffMember, final IMatchProcessor<? super StaffsAreTwiceMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<StaffsAreTwiceMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Team pTeam, final TeamMember pStaffMember) {
   ...
   * 
   */
  public StaffsAreTwiceMatch newMatch(final Team pTeam, final TeamMember pStaffMember) {
    return new StaffsAreTwiceMatch.Immutable(pTeam, pStaffMember);
   ...
   * 
   */
  public Set<Team> getAllValuesOfTeam(final StaffsAreTwiceMatch partialMatch) {
   ...
   * 
   */
  public Set<TeamMember> getAllValuesOfStaffMember(final StaffsAreTwiceMatch partialMatch) {
  ...
  @Override
  protected StaffsAreTwiceMatch tupleToMatch(final Tuple t) {
    try {
    	return new StaffsAreTwiceMatch.Immutable((model.Team) t.get(POSITION_TEAM), (model.TeamMember) t.get(POSITION_STAFFMEMBER));	
  ...
  @Override
  protected StaffsAreTwiceMatch arrayToMatch(final Object[] match) {
    try {
    	return new StaffsAreTwiceMatch.Immutable((model.Team) match[POSITION_TEAM], (model.TeamMember) match[POSITION_STAFFMEMBER]);
  ...
  @Override
  protected StaffsAreTwiceMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new StaffsAreTwiceMatch.Mutable((model.Team) match[POSITION_TEAM], (model.TeamMember) match[POSITION_STAFFMEMBER]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IMatcherFactory<StaffsAreTwiceMatcher> factory() throws IncQueryException {
    return StaffsAreTwiceMatcherFactory.instance();
  }
}
