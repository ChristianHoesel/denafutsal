...
/**
 * Pattern-specific match representation of the constraints.assistantNotPerson pattern, 
 * to be used in conjunction with {@link AssistantNotPersonMatcher}.
 * 
 ...
 * 
 */
public abstract class AssistantNotPersonMatch extends BasePatternMatch {
  private TeamMember fPerson;
  
  private static String[] parameterNames = {"Person"};
  
  private AssistantNotPersonMatch(final TeamMember pPerson) {
  ...
  public String[] parameterNames() {
    return AssistantNotPersonMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof AssistantNotPersonMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    AssistantNotPersonMatch other = (AssistantNotPersonMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return AssistantNotPersonMatcher.factory().getPattern();
  ...
  static final class Mutable extends AssistantNotPersonMatch {
  ...
  static final class Immutable extends AssistantNotPersonMatch {
