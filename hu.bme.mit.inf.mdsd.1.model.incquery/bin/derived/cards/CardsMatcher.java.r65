...
/**
 * Generated pattern matcher API of the derived.cards pattern, 
 ...
 * 
 */
public class CardsMatcher extends BaseGeneratedMatcher<CardsMatch> {
  ...
  public CardsMatch newMatch(final Team pTeam, final Event pEvent) {
    return new CardsMatch.Immutable(pTeam, pEvent);
  ...
  @Override
  protected CardsMatch tupleToMatch(final Tuple t) {
    try {
    	return new CardsMatch.Immutable((model.Team) t.get(POSITION_TEAM), (model.Event) t.get(POSITION_EVENT));	
  ...
  @Override
  protected CardsMatch arrayToMatch(final Object[] match) {
    try {
    	return new CardsMatch.Immutable((model.Team) match[POSITION_TEAM], (model.Event) match[POSITION_EVENT]);
  ...
  @Override
  protected CardsMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new CardsMatch.Mutable((model.Team) match[POSITION_TEAM], (model.Event) match[POSITION_EVENT]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
