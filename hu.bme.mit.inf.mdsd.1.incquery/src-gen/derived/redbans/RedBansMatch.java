...
/**
 * Pattern-specific match representation of the redBans pattern, 
 * to be used in conjunction with RedBansMatcher.
 * 
 ...
 * 
 */
public final class RedBansMatch extends BasePatternMatch {
  private Team fTeam;
  ...
  RedBansMatch(final Team pTeam, final Event pEvent) {
    this.fTeam = pTeam;
    this.fEvent = pEvent;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!RedBansMatch.class.equals(obj.getClass()))
