...
/**
 * Generated pattern matcher API of the redBans pattern, 
 ...
 * 
 */
public class RedBansMatcher extends BaseGeneratedMatcher<RedBansMatch> implements IncQueryMatcher<RedBansMatch> {
  ...
  public RedBansMatch newMatch(final Team pTeam, final Event pEvent) {
    return new RedBansMatch(pTeam, pEvent);
  ...
  @Override
  public RedBansMatch tupleToMatch(final Tuple t) {
    try {
    	return new RedBansMatch((model.Team) t.get(POSITION_TEAM), (model.Event) t.get(POSITION_EVENT));	
  ...
  @Override
  public RedBansMatch arrayToMatch(final Object[] match) {
    try {
    	return new RedBansMatch((model.Team) match[POSITION_TEAM], (model.Event) match[POSITION_EVENT]);
