...
/**
 * Generated pattern matcher API of the isSentOff pattern, 
 ...
 * 	M == count find redCardsOfPlayer(teamMember, _);
 * 	M == 0;
 * 	target == false;
 * } or {
 * 	M == count find redCardsOfPlayer(teamMember, _);
 ...
 * 
 */
public class IsSentOffMatcher extends BaseGeneratedMatcher<IsSentOffMatch> implements IncQueryMatcher<IsSentOffMatch> {
  ...
  public IsSentOffMatch newMatch(final TeamMember pTeamMember, final Boolean pTarget) {
    return new IsSentOffMatch(pTeamMember, pTarget);
  ...
  @Override
  public IsSentOffMatch tupleToMatch(final Tuple t) {
    try {
    	return new IsSentOffMatch((model.TeamMember) t.get(POSITION_TEAMMEMBER), (java.lang.Boolean) t.get(POSITION_TARGET));	
  ...
  @Override
  public IsSentOffMatch arrayToMatch(final Object[] match) {
    try {
    	return new IsSentOffMatch((model.TeamMember) match[POSITION_TEAMMEMBER], (java.lang.Boolean) match[POSITION_TARGET]);
