...
/**
 * Pattern-specific match representation of the cards pattern, 
 * to be used in conjunction with CardsMatcher.
 * 
 ...
 * 
 */
public final class CardsMatch extends BasePatternMatch {
  private Team fTeam;
  ...
  CardsMatch(final Team pTeam, final Event pEvent) {
    this.fTeam = pTeam;
    this.fEvent = pEvent;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!CardsMatch.class.equals(obj.getClass()))
