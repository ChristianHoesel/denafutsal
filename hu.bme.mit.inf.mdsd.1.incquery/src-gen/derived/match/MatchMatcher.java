...
/**
 * Generated pattern matcher API of the match pattern, 
 ...
 * 
 */
public class MatchMatcher extends BaseGeneratedMatcher<MatchMatch> implements IncQueryMatcher<MatchMatch> {
  ...
  public MatchMatch newMatch(final Team pTeam, final Match pMatch) {
    return new MatchMatch(pTeam, pMatch);
  ...
  public Set<Team> getAllValuesOfteam(final Match pMatch) {
    Team pTeam = null;
    return rawAccumulateAllValuesOfteam(new Object[]{pTeam, pMatch});
  }
   ...
   * 
   */
  public Set<Match> rawAccumulateAllValuesOfmatch(final Object[] parameters) {
  ...
  public Set<Match> getAllValuesOfmatch(final Team pTeam) {
    Match pMatch = null;
    return rawAccumulateAllValuesOfmatch(new Object[]{pTeam, pMatch});
  }
  
  @Override
  public MatchMatch tupleToMatch(final Tuple t) {
    try {
    	return new MatchMatch((model.Team) t.get(POSITION_TEAM), (model.Match) t.get(POSITION_MATCH));	
  ...
  @Override
  public MatchMatch arrayToMatch(final Object[] match) {
    try {
    	return new MatchMatch((model.Team) match[POSITION_TEAM], (model.Match) match[POSITION_MATCH]);
