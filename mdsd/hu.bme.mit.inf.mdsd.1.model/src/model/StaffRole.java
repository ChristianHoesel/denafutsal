...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Staff Role</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see model.ModelPackage#getStaffRole()
 * @model
 * @generated
 */
public enum StaffRole implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Staff Role</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final StaffRole[] VALUES_ARRAY =
		new StaffRole[] {
			HEAD_COACH,
			TECHNICAL_COACH,
			GOALKEEPER_COACH,
	...
	/**
	 * A public read-only list of all the '<em><b>Staff Role</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<StaffRole> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Staff Role</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StaffRole get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StaffRole result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Staff Role</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StaffRole getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			StaffRole result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Staff Role</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static StaffRole get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private StaffRole(int value, String name, String literal) {
		this.value = value;
		this.name = name;
