...
public class MainView extends ViewPart {
	...
	public void createPartControl(Composite parent) {		
		...
		{
			ExpandItem xpndtmMatchData = new ExpandItem(expandBarMatchData, SWT.NONE);
			...
			xpndtmMatchData.setHeight(xpndtmMatchData.getControl().computeSize(SWT.DEFAULT, SWT.DEFAULT).y);
		...
		fd_lblStartinglineHome.left = new FormAttachment(lblTeamHome, 0, SWT.LEFT);
		...
		fd_lblSubstitutesHome.left = new FormAttachment(lblTeamHome, 0, SWT.LEFT);
		...
		fd_lblStartingLineVisitor.left = new FormAttachment(lblTeamVisitor, 0, SWT.LEFT);
		...
		fd_lblSubstitutesVisitor.left = new FormAttachment(lblTeamVisitor, 0, SWT.LEFT);
		...
		fd_lblStaffVisitor.left = new FormAttachment(lblTeamVisitor, 0, SWT.LEFT);
		...
		manageTimeBtn.setFont(SWTResourceManager.getFont("Score Board", 16, SWT.NORMAL));
		...
		btnFaultHome.setFont(SWTResourceManager.getFont("Segoe UI", 26, SWT.BOLD));
		btnFaultHome.setText("0");
		btnFaultHome.setImage(SWTResourceManager.getImage(MainView.class, "/icons/whistle.png"));
		...
		btnFaultVisitor.setFont(SWTResourceManager.getFont("Segoe UI", 26, SWT.BOLD));
		btnFaultVisitor.setText("0");
		btnFaultVisitor.setImage(SWTResourceManager.getImage(MainView.class, "/icons/whistle.png"));
		...
		fd_btnFaultVisitor.right = new FormAttachment(manageTimeBtn, 0, SWT.RIGHT);
		...
		btnYellowHome.setImage(SWTResourceManager.getImage(MainView.class, "/icons/yellow.png"));
		...
		btnRedHome.setImage(SWTResourceManager.getImage(MainView.class, "/icons/red.png"));
		...
		btnYellowVisitor.setImage(SWTResourceManager.getImage(MainView.class, "/icons/yellow.png"));
		...
		fd_btnYellowVisitor.right = new FormAttachment(manageTimeBtn, 0, SWT.RIGHT);
		...
		btnRedVisitor.setImage(SWTResourceManager.getImage(MainView.class, "/icons/red.png"));
		...
		fd_btnGoalVisitor.right = new FormAttachment(manageTimeBtn, 0, SWT.RIGHT);
		...
		btnGoalHome.setImage(SWTResourceManager.getImage(MainView.class, "/icons/goal.png"));
