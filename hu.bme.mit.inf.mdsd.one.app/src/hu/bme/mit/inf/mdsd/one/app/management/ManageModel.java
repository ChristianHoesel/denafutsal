...
public class ManageModel implements IManageModel {
	...
	public void setThirdRefereeRefereeText(Text text, String error) {
		...
		if (valid) {
			...
			error = error
					+ "Az 3. bÌrÛ neve nem tartalmazhat speci·lis karaktert vagy sz·mot!";
			view.appendTextToLogging(error);
			text.setBackground(red);
		}
	...
	public void setSupervisorText(Text text, String error) {
		...
		if (valid) {
			...
			error = error
					+ "A fel¸gyelı neve nem tartalmazhat speci·lis karaktert vagy sz·mot!";
			view.appendTextToLogging(error);
			text.setBackground(red);
		}
	}
	...
	public void setMatchIDText(Text text, String error) {
		...
		try {
			...
			view.appendTextToLogging(e.toString());
			view.appendTextToLogging(error
					+ "A meccs azonosÌtÛ csak sz·mokat tartalmazhat!");
		}
	...
	public void setTeamHomeText(Text text, String error) {
		...
		try {
			...
			view.appendTextToLogging("Hiba! A valid·l·s nem tudott lefutni!");
	...
	/***************************************************************************
	 * XXX: Visitor csapat kezdıj·tÈkos nevÈnek lekÈrdezÈse, be·llÌt·sa,
	 * valid·l·sa
	 */
	@Override
